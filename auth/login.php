                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Login MyBPOM</h3>
                                </div>
                                <div class="card-body">
                                    <form action="proseslogin.php" method="POST">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputPassword" type="password" placeholder="Password" minlength="5" name="password" required />
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="text-muted small"> Copyright &copy; Balai Besar POM di Bandung <?= date('Y') ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
